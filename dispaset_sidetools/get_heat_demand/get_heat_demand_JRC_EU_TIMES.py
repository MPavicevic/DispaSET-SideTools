...
for c in allunits:
    ...
    if tmp.empty is True:
        ...
        chp_units[c] = tmp
        share_chp[c] = pd.DataFrame(chp_units[c]['CHP_Total_Heat_Cap'] / chp_units[c]['CHP_Total_Heat_Cap'].sum(axis=0)).T
...
for temp in ['2009', '2010', '2011', '2013']:
    for h in ['00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16',
        ...
        demand_heat[temp].loc[temp + '-02-29 ' + h + ':00:00', :] = (demand_heat[temp].loc[
                    temp + '-02-28 ' + h + ':00:00', :] + demand_heat[temp].loc[temp + '-03-01 ' + h + ':00:00',:]) / 2
