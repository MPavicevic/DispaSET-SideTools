...
def define_PP(Zone):
    ...
    #   sto_dhn_daily = sto_dhn(heat_tech, LTlayers,'DAILY',n_TD)
    #   sto_dhn_seasonal = sto_dhn(heat_tech, LTlayers,'SEASONAL',n_TD)
...
allunits.to_csv(output_folder + '/PowerPlants/' + 'PowerPlants_th.csv', index=False)
