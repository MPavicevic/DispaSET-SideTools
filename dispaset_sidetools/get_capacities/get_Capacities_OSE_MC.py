...
for model in models:
    for scenario in scenarios:
        for coverage in coverages:
            ...
            indexNames = model_data[(model_data['Unit'] == 'GWh') & (
                        model_data['Variable'] == 'Capacity|Electricity|Hydro Reservoir')].index
            ...
            if len(region_list) == 0:
                ...
                typical_tech = pd.DataFrame(
                    columns=['COMC', 'GTUR', 'HDAM', 'HPHS', 'HROR', 'ICEN', 'STUR', 'WTON', 'WTOF', 'PHOT', 'BEVS',
                             'BATS'])
                for region in region_list:
                    tmp_OTH_BATS = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Storage|Liion|Power')]
                    tmp_OTH_BATS_STOR = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Storage|Liion|Energy')]
                    tmp_OTH_BATS_CRATE = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Storage|Liion|C-rate')]
                    tmp_NUC_STUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Nuclear')]
                    tmp_NUC_STUR['Fuel'], tmp_NUC_STUR['Technology'] = 'NUC', 'STUR'
                    tmp_LIG_STUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Lignite')]
                    tmp_LIG_STUR['Fuel'], tmp_LIG_STUR['Technology'] = 'LIG', 'STUR'
                    tmp_HRD_STUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Hard Coal')]
                    tmp_HRD_STUR['Fuel'], tmp_HRD_STUR['Technology'] = 'HRD', 'STUR'
                    tmp_GAS_COMC = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Gas CCGT')]
                    tmp_GAS_COMC['Fuel'], tmp_GAS_COMC['Technology'] = 'GAS', 'COMC'
                    tmp_GAS_GTUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Gas OCGT')]
                    tmp_GAS_GTUR['Fuel'], tmp_GAS_GTUR['Technology'] = 'GAS', 'GTUR'
                    tmp_OIL_STUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Oil')]
                    tmp_OIL_STUR['Fuel'], tmp_OIL_STUR['Technology'] = 'OIL', 'STUR'
                    tmp_BIO_STUR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Bioenergy')]
                    tmp_BIO_STUR['Fuel'], tmp_BIO_STUR['Technology'] = 'BIO', 'STUR'
                    tmp_OTH_STUR = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Other nonrenewable')]
                    tmp_OTH_STUR['Fuel'], tmp_OTH_STUR['Technology'] = 'OTH', 'STUR'
                    tmp_WST_STUR = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Other renewable')]
                    tmp_WST_STUR['Fuel'], tmp_WST_STUR['Technology'] = 'WST', 'STUR'
                    tmp_WIN_WTON = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Wind Onshore')]
                    tmp_WIN_WTON['Fuel'], tmp_WIN_WTON['Technology'] = 'WIN', 'WTON'
                    tmp_WIN_WTOF = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Wind Offshore')]
                    tmp_WIN_WTOF['Fuel'], tmp_WIN_WTOF['Technology'] = 'WIN', 'WTOF'
                    tmp_SUN_PHOT = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Solar PV')]
                    tmp_SUN_PHOT['Fuel'], tmp_SUN_PHOT['Technology'] = 'SUN', 'PHOT'
                    tmp_WAT_HROR = model_data[
                        (model_data['Region'] == region) & (model_data['Variable'] == 'Capacity|Electricity|Hydro ROR')]
                    tmp_WAT_HROR['Fuel'], tmp_WAT_HROR['Technology'] = 'WAT', 'HROR'
                    tmp_WAT_HDAM = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Hydro Reservoir')]
                    tmp_WAT_HDAM['Fuel'], tmp_WAT_HDAM['Technology'] = 'WAT', 'HDAM'
                    tmp_WAT_HPHS = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Storage|Pumped hydro|Power')]
                    tmp_WAT_HPHS['Fuel'], tmp_WAT_HPHS['Technology'] = 'WAT', 'HPHS'
                    tmp_WAT_HPHS_STOR = model_data[(model_data['Region'] == region) & (
                                model_data['Variable'] == 'Capacity|Electricity|Storage|Pumped hydro|Energy')]

                    batteries, batteries_stor, batteries_crate = batteries.append(tmp_OTH_BATS), batteries_stor.append(
                        tmp_OTH_BATS_STOR), batteries_crate.append(tmp_OTH_BATS_CRATE)

                    tmp_capacities = [tmp_NUC_STUR, tmp_LIG_STUR, tmp_HRD_STUR, tmp_GAS_COMC, tmp_GAS_GTUR,
                                      tmp_OIL_STUR, tmp_BIO_STUR, tmp_OTH_STUR,
                                      tmp_WST_STUR, tmp_WIN_WTON, tmp_WIN_WTOF, tmp_SUN_PHOT, tmp_WAT_HROR,
                                      tmp_WAT_HDAM, tmp_WAT_HPHS]
                    ...
                    tmp_technologies = [tmp_GAS_COMC, tmp_GAS_GTUR, tmp_WIN_WTON, tmp_WIN_WTOF, tmp_SUN_PHOT,
                                        tmp_WAT_HROR, tmp_WAT_HDAM, tmp_WAT_HPHS]
                ...
                capacities = pd.DataFrame(capacities, index=zones,
                                          columns=['BIO', 'GAS', 'HRD', 'LIG', 'GEO', 'NUC', 'OIL', 'OTH', 'SUN', 'WIN',
                                                   'WAT', 'PEA', 'WST'])
                ...
                batteries, batteries_stor, batteries_crate = batteries.set_index('Region'), batteries_stor.set_index(
                    'Region'), batteries_crate.set_index('Region')
                tmp_batteries = pd.DataFrame([batteries['Value'] * 1000, batteries_stor['Value'] * 1000],
                                             ['Power', 'Storage']).T
                ...
                if YEAR == 2016:
                    ...
                    # %% Proces data
                    chp_max_capacities = pd.DataFrame(index=capacities.index,
                                                      columns=capacities.columns)  # zamjeni index i column
                    ...
                    # %% GAS
                    typical_gas = pd.DataFrame([typical_tech['COMC'], typical_tech['GTUR'], typical_tech['ICEN'],
                                                typical_tech['STUR']]).transpose()
                    ...
                    def get_typical_hydro(typical_hydro, clustering=None):
                        ...
                        if clustering == 'On':
                            ...
                            typical_wat['cluster'], typical_wat['sum'] = typical_wat['HDAM'] + typical_wat[
                                'HPHS'], typical_wat.sum(axis=1)
                    ...
                    typical_wat = get_typical_hydro(typical_hydro=pd.DataFrame(
                        [typical_tech['HDAM'], typical_tech['HROR'], typical_tech['HPHS']]).transpose(),
                                                    clustering='Off')
                    ...
                    for f_stur in ['BIO', 'HRD', 'LIG', 'PEA', 'OIL', 'WST', 'GEO']:
                        chp_max_capacities[f_stur] = capacities[f_stur] / typical_chp.loc[
                            (typical_chp['Fuel'] == f_stur) & (
                                        typical_chp['Technology'] == 'STUR'), 'CHPPowerToHeat'].values
                    ...
                    for f in fuels:
                        ...
                        if f == 'GAS':
                            ...
                            tmp_new_df_pow_gas['GAS_ICEN'] = new_df[f] * typical_gas['ICEN'] * typical_chp.loc[
                                (typical_chp['Fuel'] == 'GAS') & (
                                            typical_chp['Technology'] == 'ICEN'), 'CHPPowerToHeat'].values
                            new_df_pow = pd.DataFrame(tmp_new_df_pow_gas.sum(axis=1), columns=['GAS'])
                        else:
                            new_df_pow = new_df * typical_chp.loc[(typical_chp['Fuel'] == f) & (
                                        typical_chp['Technology'] == 'STUR'), 'CHPPowerToHeat'].values
                    ...
                    for c in countries:
                        ...
                        tmp_other = pd.DataFrame(
                            [tmp_cap['GEO'], tmp_cap['BIO'], tmp_cap['HRD'], tmp_cap['LIG'], tmp_cap['NUC'],
                        ...
                        df_merged = df_merged.merge(tmp_BAT_BEV, how='outer', left_index=True, right_index=True,
                                                    on=['OTH'])
                        cap[c] = df_merged
                        ...
                        tmp_other_chp = pd.DataFrame(
                            [tmp_cap_chp['GEO'], tmp_cap_chp['BIO'], tmp_cap_chp['HRD'], tmp_cap_chp['LIG'],
                        ...
                        if cap_tot.loc[i, j] > 0:
                            ...
                            if len(tmp) == 0:
                                ...
                                if len(typical[(typical.Technology == i) & (typical.Fuel == "*")]):
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical unit found, using the generic unit for the provided technology')
                                    ...
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical unit found, using the generic unit for the provided fuel')
                                    tmp = typical[(typical.Technology == i) & (typical.Fuel == "*")]
                                    units[name] = tmp.iloc[0, :]
                                    units.loc['Technology', name], units.loc['Fuel', name] = i, j
                                elif len(typical[(typical.Technology == '*') & (typical.Fuel == "*")]):
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical unit found, using the generic unit definition (*,*)')
                                    tmp = typical[(typical.Technology == '*') & (typical.Fuel == "*")]
                                    units[name] = tmp.iloc[0, :]
                                    units.loc['Technology', name], units.loc['Fuel', name] = i, j
                                else:
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical unit found, no generic unit found. The entry will be discarded!!')
                            elif len(tmp) == 1:
                                units[name] = tmp.iloc[0, :]
                            elif len(tmp) > 1:
                                print(
                                    'Country ' + c + ' (' + i + ',' + j + '): more than one typical unit found, taking average')
                                units[name] = tmp.mean()
                                units.loc['Technology', name], units.loc['Fuel', name] = i, j
                            ...
                            if units.loc['PowerCapacity', name] == 0:
                                ...
                                units.loc['Nunits', name] = np.ceil(
                                    cap_tot.loc[i, j] / units.loc['PowerCapacity', name])
                        ...
                        if cap_tot_chp.loc[i, j] > 0:
                            ...
                            if len(tmp) == 0:
                                ...
                                if len(typical_chp[(typical_chp.Technology == i) & (typical_chp.Fuel == "*")]):
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical CHP unit found, using the generic unit for the provided technology')
                                    ...
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical CHP unit found, using the generic unit for the provided fuel')
                                    tmp = typical_chp[(typical_chp.Technology == i) & (typical_chp.Fuel == "*")]
                                    units_chp[name] = tmp.iloc[0, :]
                                    units_chp.loc['Technology', name], units_chp.loc['Fuel', name] = i, j
                                elif len(typical_chp[(typical_chp.Technology == '*') & (typical_chp.Fuel == "*")]):
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical CHP unit found, using the generic unit definition (*,*)')
                                    tmp = typical_chp[(typical_chp.Technology == '*') & (typical_chp.Fuel == "*")]
                                    units_chp[name] = tmp.iloc[0, :]
                                    units_chp.loc['Technology', name], units_chp.loc['Fuel', name] = i, j
                                else:
                                    print(
                                        '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): no typical CHP unit found, no generic unit found. The entry will be discarded!!')
                            elif len(tmp) == 1:
                                units_chp[name] = tmp.iloc[0, :]
                            elif len(tmp) > 1:
                                print(
                                    '[INFO    ]: ' + 'Country ' + c + ' (' + i + ',' + j + '): more than one typical CHP unit found, taking average')
                            ...
                            if units_chp.loc['PowerCapacity', name] == 0:
                                ...
                                units_chp.loc['Nunits', name] = np.ceil(
                                    cap_tot_chp.loc[i, j] / units_chp.loc['PowerCapacity', name])
                                units_chp.loc['PowerCapacity', name] = cap_tot_chp.loc[i, j] / units_chp.loc[
                                    'Nunits', name]
                            ...
                            if TES_CAPACITY == 0:
                                ...
                                tmp_tes = units_chp.T
                                tmp_tes['STOCapacity'] = tmp_tes['PowerCapacity'] / tmp_tes[
                                    'CHPPowerToHeat'] * TES_CAPACITY
