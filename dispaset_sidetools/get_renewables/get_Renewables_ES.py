...
AvailFactors_ES = from_excel_to_dataFrame(input_folder + 'DATA_preprocessing_BE.xlsx', 'AvailabilityFactors')
...
for x in countries:
    ...
    AF = AvailFactors
    AF_countr = [x + '_' + s for s in AvailFactors2]

    tmp_WTON[x]= AvailFactors_ES[AF_countr[0]]
    tmp_WTOF[x]= AvailFactors_ES[AF_countr[1]]
    tmp_PV[x]= AvailFactors_ES[AF_countr[2]]
